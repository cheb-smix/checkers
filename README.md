...
# TODO
0. Дамка не видит ход дальше 6 ячеек (большая диагональ)
0. Перестать слать путь, маску и взятия шашек с фронта, все делать на бэке
...
5. Включить запись ходов и оформление завершения игры, как для оффлайн так и для онлайн игр

-  Таймер оставшегося времени хода сделать видным 
-  Нет смысла в счетчике шагов на фронте
...
-  Bluetooth режим?
-  Нужны звуки Rampage? Или оставить игру лаконично звучащей
-  Для сокетов стало быть - https://www.npmjs.com/package/cordova-plugin-websocket (вряд ли, скорей всего нативно)

# Баги
- При использовании хода из буфера через ход бот снова пытается его сходить.. ?? шта (мошт он повторно юзает буфер??)
